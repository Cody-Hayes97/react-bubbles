...
a token is a way for an api to know that the user accessing it is authenticated to use the api

- [ ] What steps can you take in your web apps to keep your data secure?

you can implement yup authentication for your forms, but most importantly, using axiosWithAuth and PrivateRoutes to make sure nobdy sees what they arent supposed to.

- [ ] Describe how web servers work.

a web server stores information such as web pages, when a user sendes a request to a server, the server responds with either the requested info or an error if it could not properly retrieve the information

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

axios.post = Create axios.get = Read axios.put = Update and axios.delete = Delete
